...
//! 3. **Invokes** the pure-Rust CPU reference [`mosaic_compositor::composite`]
...
use mosaic_compositor::pipeline::{composite, CanvasColor, Nv12Image, Tile};
