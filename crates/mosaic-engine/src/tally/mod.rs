...
//! resolved per-tile [`TallyState`](mosaic_core::tally::TallyState)
...
//!   a bus's wire vocabulary into a Mosaic tally state.
...
//!   [`TallyState`](mosaic_core::tally::TallyState) per tile under a defined
...
//! [`MediaTime`](mosaic_core::time::MediaTime). The arbiter and GPIO points
