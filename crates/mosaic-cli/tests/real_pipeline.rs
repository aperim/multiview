//! End-to-end test of the **real** libav\* `mosaic run` pipeline (the `ffmpeg`
//! feature).
//!
...
//! file** to confirm it is a real, playable mosaic: the right codec/resolution,
...
#[tokio::test]
async fn real_pipeline_produces_a_playable_mosaic_and_hls() {
    ...
    // ffprobe the produced file: a real, playable mpeg2video 1280x720 mosaic
