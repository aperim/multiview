//! # mosaic-output
//!
//! Output sinks/servers and packaging for the **Mosaic** live video mosaic
...
//!
//! - [`hls`] — HLS / LL-HLS playlist **text** generation (ADR-0007: Mosaic
...
//!   of `mosaic-input::tsl`. Socket-free (a later integration) and off the engine
//!   hot path.
//!
...
/// `mosaic-ffmpeg`'s safe encoder/muxer wrappers. Behind the off-by-default
