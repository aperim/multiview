...
//! validated [`mosaic_core::layout::VideoWall`] the engine consumes.
//!
...
impl HeadConfig {
    /// Lower this head into a [`mosaic_core::layout::Head`].
...
impl WallConfig {
    /// Lower this wall into a [`mosaic_core::layout::VideoWall`] (unvalidated
    /// shape; call [`mosaic_core::layout::VideoWall::validate`] or
    /// [`WallConfig::validate`]).
    #[must_use]
