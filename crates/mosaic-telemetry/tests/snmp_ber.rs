...
#[test]
fn mib_oids_hang_off_the_mosaic_enterprise_arc() {
    // The notification OIDs and object OIDs must descend from the Mosaic
...
fn raise_trap_carries_severity_and_clear_trap_uses_clear_oid() {
    use mosaic_core::alarm::{AlarmId, AlarmKind, AlarmRecord, AlarmScope};
