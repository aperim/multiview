...
//! messages. Mosaic ingests them so the monitoring / overlay subsystems can show
...
///
/// This is the vocabulary the rest of Mosaic consumes: the realtime API surfaces
