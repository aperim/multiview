...
///
/// This is the serde-serializable mirror of [`mosaic_core::traits::SourceState`]
...
/// `mosaic-engine`; this crate only carries them.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
...
/// produced by the tally arbiter in `mosaic-engine` and the
/// [`target`](TallyEvent::target) it applies to. Rendered by `mosaic-overlay`.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
