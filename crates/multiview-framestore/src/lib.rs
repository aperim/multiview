...
//!   [`MediaTime`](multiview_core::time::MediaTime), so the whole ladder is
//!   property/state-machine testable with no real clock.
//!
//! ```
//! use multiview_framestore::{TileStore, TileThresholds, TileRead};
