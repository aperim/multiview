...
//! engine.
//!
//! Mosaic's engine (`mosaic-engine`) does not yet expose an inbound command
...
pub enum Command {
    ...
    /// Apply a new layout to the running mosaic.
    ApplyLayout {
        /// Correlation id for the async outcome.
        op: OperationId,
    ...
    SetTallyOverride {
        ...
        target: mosaic_events::TallyTarget,
        /// The colour to force, or `None` to clear the override.
        color: Option<mosaic_core::tally::TallyColor>,
    },
}
