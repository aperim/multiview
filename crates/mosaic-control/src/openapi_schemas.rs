//! `OpenAPI` schema mirrors for the `mosaic-core` alarm value types
//! (feature `openapi`).
//!
//! The alarm REST surface returns the `serde`-serialised
//! [`mosaic_core::alarm::AlarmRecord`] verbatim. That type lives in the frozen
//! `mosaic-core` crate and deliberately carries no `utoipa::ToSchema` derive (it
...
/// `OpenAPI` mirror of [`mosaic_core::alarm::PerceivedSeverity`] (X.733).
///
...
/// `OpenAPI` mirror of [`mosaic_core::alarm::AlarmKind`] (probe/fault taxonomy).
///
/// Serde-equivalent: a unit enum rendered as its `PascalCase` variant name.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
#[non_exhaustive]
...
/// `OpenAPI` mirror of [`mosaic_core::alarm::AlarmScope`].
///
...
pub enum AlarmScopeDoc {
    ...
    /// A mosaic tile, by zero-based index.
    Tile {
...
/// `OpenAPI` mirror of [`mosaic_core::alarm::AckState`].
///
...
/// `OpenAPI` mirror of [`mosaic_core::alarm::AlarmRecord`].
///
...
/// `OpenAPI` mirror of [`mosaic_core::tally::TallyColor`] (the TSL UMD palette).
///
/// Serde-equivalent: a unit enum rendered as its `PascalCase` variant name.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
#[non_exhaustive]
...
/// `OpenAPI` mirror of [`mosaic_core::tally::BusSource`].
///
/// Serde-equivalent: internally tagged on `kind`, `snake_case` variant tags.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
#[serde(tag = "kind", rename_all = "snake_case")]
...
/// `OpenAPI` mirror of [`mosaic_core::tally::TallyState`].
///
...
/// `OpenAPI` mirror of [`mosaic_events::TallyTarget`].
///
/// Serde-equivalent: internally tagged on `kind`, `snake_case` variant tags.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
#[serde(tag = "kind", rename_all = "snake_case")]
...
/// `OpenAPI` mirror of [`mosaic_config::SourceRecall`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
...
/// `OpenAPI` mirror of [`mosaic_config::TallyRecall`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
...
/// `OpenAPI` mirror of [`mosaic_config::UmdRecall`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
...
/// `OpenAPI` mirror of [`mosaic_config::Salvo`].
///
...
/// `OpenAPI` mirror of [`mosaic_config::BitColor`].
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
...
/// `OpenAPI` mirror of [`mosaic_config::IndexCell`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
...
/// `OpenAPI` mirror of [`mosaic_config::TallyProfile`].
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, ToSchema)]
