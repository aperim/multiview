...
//!
//! Ember+ is the second openly-published router/device-control protocol Mosaic
...
//!
//! This module owns the **pure** codec for the slice Mosaic needs — enough to
...
/// A typed Glow parameter value (the subset Mosaic reads/writes).
///
...
///
/// This is the minimal Glow shape Mosaic needs to read a router's
