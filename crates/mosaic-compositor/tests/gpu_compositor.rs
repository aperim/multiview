...
use mosaic_compositor::error::Error;
use mosaic_compositor::gpu::GpuCompositor;
use mosaic_compositor::pipeline::{composite as cpu_composite, CanvasColor, Nv12Image, Tile};
...
fn gpu_rejects_too_many_tiles() {
    ...
    let many: Vec<Tile<'_>> = (0..=(mosaic_compositor::gpu::MAX_TILES as usize))
        .map(|_| Tile {
            image: &img,
            dst_x: 0,
            dst_y: 0,
