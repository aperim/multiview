...
//! Mosaic's best-effort, read-only preview side-channel. The library target is
//! `mosaic_preview`.
//!
...
//!
//! [`docs/research/preview-subsystem.md`]: https://github.com/aperim/mosaic/blob/main/docs/research/preview-subsystem.md
//!
