...
- [ADR-0012](ADR-0012.md) — LGPL-clean default build; GPL/nonfree/NDI strictly opt-in; project dual MIT OR Apache-2.0 *(Proposed — superseded by [ADR-0042](ADR-0042.md))*
