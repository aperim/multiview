...
### RIST — Reliable Internet Stream Transport (input + output) (brief [rist-transport](../research/rist-transport.md); [ADR-0060](../decisions/ADR-0060.md))

> **Gating (2026-06-13):** design merged (brief + ADR-0060, **Proposed**), code NOT started. A
